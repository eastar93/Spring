...
public class MVCController {
	...
	// 단일 자룧형이었기 때문에 get, post방식으로 전달되는 
	// 데이터를 자동으로 받아서 처리할 수 있었습니다.
	// 현재 TestVO 내부에는 int age, String name이 들어있고
	// TestVO를 아래와 같이 선언하는 것만으로도, int age, String name을
	// 선언하는것과 같은 효과를 볼 수 있습니다.
	// wmr ? age = OOO & name = OOO 라고 적는 데이터를 받아올 수 있습니다.
	@RequestMapping(value="/getVO")
	public String getVO(TestVO vo, Model model) {
		System.out.println("받아온 객체는 : " + vo);
